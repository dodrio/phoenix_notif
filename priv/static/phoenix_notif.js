var PhoenixNotif = (() => {
  ...
  function animateOut(notificationGroupId, notification) {
  ...
  function createPhoenixNotifHook(animateOptions) {
    return {
      mounted() {
        ...
        this.el.addEventListener("notification-dismiss", (event) => __async(this, null, function* () {
          event.stopPropagation();
          doAnimations(groupId, this.el, animateOptions);
          yield animateOut(groupId, this.el);
          switch (type) {
            case "flash":
              this.el.remove();
              break;
  ...
  return __toCommonJS(phoenix_notif_exports);
})();
